...
use App\Http\Controllers\App\CvPdfController;
...
Route::prefix('panel')->name('panel.')->middleware(['auth.api', 'auth.api.candidate', 'panel.locale'])->group(function () {
    ...
    Route::post('/cv-merkezi/pdf', CvPdfController::class)->name('cv.pdf');
    ...
    Route::post('/cv-merkezi/belgeler/{documentId}/taslak-bildirimi/kapat', [CvBuilderController::class, 'dismissBuilderImportNotice'])->name('cv.builder-import-notice.dismiss');
