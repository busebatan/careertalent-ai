...
<div class="mx-auto max-w-4xl" x-data="careerChat({{ Js::from($messages) }}, @js(route('panel.chat.send')), @js(route('panel.chat.clear')), {{ Js::from(['failed' => __('panel.chat.failed')]) }})">
    ...
    <section class="panel-card flex min-h-[32rem] flex-col p-5">
        <div class="flex-1 space-y-3 overflow-y-auto rounded-2xl border border-slate-200 bg-slate-100 p-4 dark:border-slate-800 dark:bg-slate-950/70">
            <div x-show="!modeSelected" class="space-y-4">
    ...
    <div class="grid gap-4 md:grid-cols-3">
        ...
        <button
            type="button"
            @click="selectMode('cv')"
            class="rounded-2xl border border-slate-200 bg-white p-5 text-left shadow-sm transition hover:border-emerald-500 hover:shadow-md dark:border-slate-700 dark:bg-slate-800">
            ...
            <p class="mt-2 text-sm text-slate-600 dark:text-slate-300">
                CV'nizi analiz eder ve geliştirme önerileri sunar.
            </p>
        ...
        <button
            ...
            <p class="mt-2 text-sm text-slate-600 dark:text-slate-300">
                Mülakat simülasyonu ile pratik yapın.
            </p>
        ...
        <button
            ...
            <p class="mt-2 text-sm text-slate-600 dark:text-slate-300">
                Kariyer hedeflerinize uygun yol haritası oluşturur.
            </p>
