...
class EnsureApiCompany
{
    private const ROUTE_PERMISSIONS = [
        ...
        'company.positions.show' => 'positions.view',
        'company.positions.new' => 'positions.write',
        ...
        'company.positions.copy' => 'positions.write',
        'company.positions.analyze' => 'positions.write',
        'company.positions.analysis-status' => 'positions.view',
        'company.positions.criteria.*' => 'positions.write',
        'company.positions.share-links.*' => 'positions.write',
        'company.positions.applications' => 'applications.view',
        'company.positions.applications.update' => 'applications.write',
        'company.ats' => 'ats_config.view',
        'company.ats.update' => 'ats_config.write',
