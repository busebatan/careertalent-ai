...
from app.api.v1 import admin, auth, career, career_data, career_roles, company, cv, engagement, panel, public_recruiting
...
api_router.include_router(public_recruiting.router, prefix="/public", tags=["Public Recruiting"])
